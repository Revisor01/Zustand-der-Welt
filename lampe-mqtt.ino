...
// Allgemeine Einstellungen vornehemen
...
//Punkte für Bewertungen festlegen
    ...
    Serial.println("Keine Verbindung zu meaningcloud.com möglich.");
  }
...
//Nachrichten holen
  http.begin(clientt, "http://newsapi.org/v2/top-headlines?country=de&apiKey=API_TOKEN");
    ...
    if (httpCode == 200) {
      ...
      //Durch Überschriften loopen und Wertung abrufen, Hier kann die Anzahl der zu analysierenden Nachrichten festglegt werden (Aktueller Wert: 15)
      for (int i = 0; i < 15; i++) {
